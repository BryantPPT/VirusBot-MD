...
def shell():
    ...
    if not args.mini:
        ...
        try:
            ...
            printer('❥ *No se pudo obtener la lista de los servidores.*', error=True)
            raise SpeedtestCLIError(get_exception())
        ...
        if args.server and len(args.server) == 1:
            printer('❥ *Obteniendo info del mejor servidor...*', quiet)
        else:
            printer('❥ *Se seleccionó el mejor servidor...*', quiet)
