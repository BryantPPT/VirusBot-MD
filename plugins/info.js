...
let vcard = `BEGIN:VCARD\nVERSION:3.0\nN:; Virus Lyrics👑;;;\nFN: Virus Lyrics\nORG: Virus Lyrics👑\nTITLE:\nitem1.TEL;waid=15166130120:+15166130120\nitem1.X-ABLabel:Propietario 👑\nX-WA-BIZ-DESCRIPTION:Escribele solo para cosas del bot.\nX-WA-BIZ-NAME:Owner 👑\nEND:VCARD`
let a = await conn.sendMessage(m.chat, { contacts: { displayName: 'virus 🦠', contacts: [{ vcard }] }}, {quoted: m})
...
conn.sendMessage(`15166130120@s.whatsapp.net`, {text: `╭━━〔 *𝚁𝙴𝙿𝙾𝚁𝚃𝙴 | 𝚁𝙴𝙿𝙾𝚁𝚃* 〕━━⬣\n┃\n┃✿ *𝙽𝚞𝚖𝚎𝚛𝚘 | 𝚗𝚞𝚖𝚋𝚎𝚛*\n┃⇢ wa.me/${m.sender.split("@")[0]}\n┃\n┃✿ *𝙼𝚎𝚗𝚜𝚊𝚓𝚎 | 𝚝𝚎𝚡𝚝*\n┃: ${text}┃\n╰━━━〔 *${vs}* 〕━━━⬣` })
