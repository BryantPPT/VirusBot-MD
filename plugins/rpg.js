...
let minar = `${pickRandom([
    '¡Eres un dios de la minería! 🦠 ¡Has minado una gran cantidad!', 
    '¡🌟🦠 Maravilloso! Obtienes mucho 💎 por tu excelente minería', 
    '¡Qué increíble! 😍⛏️ Eres el rey de las minas y obtuviste', 
    ...
    '⛏️💫 ¡Mina como un campeon! Has obtenido', 
    '🦠🌈 ¡Sigue brillando! Ahora tienes', 
    '😻 ¡La suerte está de tu lado, minero estrella! 🌟 Obtienes', 
    ...
    '👑⛏️ ¡El rey de las minas vuelve a triunfar! Ahora tienes', 
    '🌟🛣️ Tu camino como minero es brillante, has minado y obtuviste', 
    '🌈 ¡La fortuna te sonríe mientras minas! Ahora tienes', 
    '🌸💪 Eres imparable, ¡obtienes una gran recompensa por tu minería!', 
    '🌟🌟 ¡Has demostrado ser el mejor en las minas! Obtienes', 
...
let robar = `${pickRandom([
    '👑💰 ¡Eres el rey del robo! Robaste un banco y obtuviste', 
    '💎🦠 ¡Maestro del crimen! Lograste negociar con la mafia y obtuviste', 
    ...
    '💸😎 ¡Te convertiste en el ladron más buscado, pero el botín es enorme! Ahora tienes', 
    '🎩🎁 ¡Qué elegancia! Robaste una mansión de lujo y obtuviste', 
    '👜💎 Te hiciste pasar por un millonario y robaste una joya única. ¡Increíble!', 
    ...
    '🎯💸 ¡Robaste con precisión de experto! Ahora tienes en tus manos', 
...
let robmal = `${pickRandom([
    ...
    '🚨🔔 ¡La alarma sonó y fuiste capturado tratando de robar un almacén! ¡Perdiste!', 
    ...
    '🚔💸 ¡Fuiste atrapadp en el acto! Perdiste todo lo robado.', 
    '🎭❌ ¡Tu máscara cayó en pleno robo y fuiste identificado! Perdiste:', 
    '🚨👮‍♀️ ¡Te atraparon justo antes de escapar! ¡Perdiste tu botín.'
])}`

let verificados2 = 'https://i.ibb.co/w8LHrKW/IMG-342.jpg';
let verificadosError = 'https://i.ibb.co/tw8WG5tk/IMG-3422-1.jpg';
global.ch = { ch1: '120363383276028598@newsletter' };
...
> mira tu registro aquí https://whatsapp.com/channel/0029Vb1faMi6xCSVWEElsQ38`
    }, { quoted: m, ephemeralExpiration: 24 * 60 * 100, disappearingMessagesInChat: 24 * 60 * 100 });
    await delay(2000);
    conn.sendMessage(m.chat, {
    ...
    await conn.sendMessage("120363383276028598@newsletter", {
...
if (global.db.data.users[m.sender].money < 0) return m.reply(`《💰》${robar} ${money} 🪙 Virus Coins`).catch(global.db.data.users[m.sender].money += money) 
...
if (media === 'text3') m.reply(`《💰》${robar}\n\n💎 ${diamond} diamante\n🪙${money} Virus Coins`).catch(global.db.data.users[m.sender].limit += diamond).catch(global.db.data.users[m.sender].money += money) 
